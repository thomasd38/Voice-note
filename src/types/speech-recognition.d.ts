/**
 * Déclarations minimales de la Web Speech API.
 * TypeScript ne fournit pas ces types (l'API n'est pas standardisée) : on ne
 * déclare que ce que `WebSpeechProvider` utilise réellement.
 */
